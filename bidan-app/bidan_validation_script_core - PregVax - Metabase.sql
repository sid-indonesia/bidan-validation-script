...
WHERE
--     ibu."json" ->> 'dateCreated' BETWEEN '2023-04-26T10:20:00' AND '2023-04-26T23:00:00'
-- 	AND
-- 	ibu."json" -> 'relationships' ->> 'ibuCaseId' IS NULL
-- 	AND e_identitas_ibu."json" ->> 'providerId' ILIKE 'demo_april2023'

    ibu."json" ->> 'dateCreated' BETWEEN {{ date_created_before }} AND {{ date_created_after }}
	AND
	ibu."json" -> 'relationships' ->> 'ibuCaseId' IS NULL
	AND e_identitas_ibu."json" ->> 'providerId' ILIKE {{ provider_id }}
ORDER BY
    1;
